        ...
        when (v?.id) {
            R.id.btn_move_activity_data -> {
                ...
                moveWithDataIntent.putExtra(
                    MoveWithDataActivity.EXTRA_NAMA_LENGKAP, namaLengkapValue
                )
                moveWithDataIntent.putExtra(
                    MoveWithDataActivity.EXTRA_NAMA_PANGGILAN, namaPanggilanValue
                )
                moveWithDataIntent.putExtra(
                    MoveWithDataActivity.EXTRA_NPM, npmValue
                )
                moveWithDataIntent.putExtra(
                    MoveWithDataActivity.EXTRA_ALAMAT, alamatValue
                )
